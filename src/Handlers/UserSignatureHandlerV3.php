...
/**
 * Ebics 3.0 Class AuthSignatureHandler manage body DOM elements.
 *
 ...
 * @internal
 */
final class UserSignatureHandlerV3 extends UserSignatureHandler
{
    public function handleXml(UserSignature $xml, string $digest): void
    {
        $ns = 'http://www.ebics.org/S002';
