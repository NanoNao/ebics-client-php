...
class EbicsClientV25Test extends AbstractEbicsTestCase
{
    ...
    public function testHEV(int $credentialsId, array $codes): void
    {
        ...
        $client = $this->setupClientV25($credentialsId, $codes['HEV']['fake'], false, $logger);
    ...
    {
        $logger = new ArrayLogger();
        $client = $this->setupClientV25($credentialsId, $codes['INI']['fake'], false, $logger);
    ...
    {
        $logger = new ArrayLogger();
        $client = $this->setupClientV25($credentialsId, $codes['HPB']['fake'], false, $logger);
